...
public class MainFormUI extends javax.swing.JFrame {
    ...
    public MainFormUI() {
        ...
        EventTableModel eventTableModel = new EventTableModel(eventListOriginal);
...
//        recommandEventList.add(recommandEvent5);
        try {
            recommandEventList = GoService.getInstance().bubbleSortEventByTime();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        recommandEventLbl2 = new javax.swing.JLabel();
        newGroupBtn = new javax.swing.JButton();
        sortFilterComboBox = new javax.swing.JComboBox<>();
        ...
        recommandEventLbl.setFont(new java.awt.Font("Lucida Grande", 0, 24)); // NOI18N
        recommandEventLbl.setText("    Find your next event");
        jPanel.add(recommandEventLbl);
        recommandEventLbl.setBounds(494, 80, 340, 30);
        ...
        searchTxt.setBounds(454, 116, 215, 35);

        allBtn.setBackground(new java.awt.Color(72, 124, 175));
        allBtn.setText("All events");
        ...
        jPanel.add(allBtn);
        allBtn.setBounds(757, 116, 85, 35);

        recommandEventLbl2.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N
        recommandEventLbl2.setText("You might be interested in...");
        jPanel.add(recommandEventLbl2);
        recommandEventLbl2.setBounds(460, 160, 259, 19);
        ...
        sortFilterComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "sort by time", "sort by popularity", "filter by biking", "filter by skateboarding", "filter by snowboarding" }));
        sortFilterComboBox.setToolTipText("");
        sortFilterComboBox.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                sortFilterComboBoxItemStateChanged(evt);
            }
        });
        jPanel.add(sortFilterComboBox);
        sortFilterComboBox.setBounds(690, 160, 150, 27);
        ...
        searchBtn1.setBounds(670, 116, 85, 35);
    ...
    private void searchBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtn1ActionPerformed
        ...
        recommandEventTable.setModel(eventTableModel);
        TableColumnModel tcm2 = recommandEventTable.getColumnModel();
        TableColumn tc2 = tcm2.getColumn(0);
        tc2.setPreferredWidth(200);
        tc2.setCellRenderer(new RecommandedEventCellRender());
        recommandEventTable.repaint();
    }//GEN-LAST:event_searchBtn1ActionPerformed

    private void sortFilterComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_sortFilterComboBoxItemStateChanged
        ArrayList<EventVO> eventListNew = new ArrayList<EventVO>();
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            if (sortFilterComboBox.getSelectedIndex() == 0) {
                try{
                    eventListNew = GoService.getInstance().bubbleSortEventByTime();
            ...
            else if (sortFilterComboBox.getSelectedIndex() == 2) {
                for (int i = 0; i < recommandEventList.size(); i++) {
                    EventVO event = new EventVO();
                    event = (EventVO) recommandEventList.get(i);
                ...
                tc2.setPreferredWidth(200);
                tc2.setCellRenderer(new RecommandedEventCellRender());
            } else if (sortFilterComboBox.getSelectedIndex() == 3) {
                for (int i = 0; i < recommandEventList.size(); i++) {
                    EventVO event = new EventVO();
                    event = (EventVO) recommandEventList.get(i);
                ...
                tc2.setPreferredWidth(200);
                tc2.setCellRenderer(new RecommandedEventCellRender());
            }else if (sortFilterComboBox.getSelectedIndex() == 4) {
                for (int i = 0; i < recommandEventList.size(); i++) {
                    EventVO event = new EventVO();
                    event = (EventVO) recommandEventList.get(i);
    ...
    }//GEN-LAST:event_sortFilterComboBoxItemStateChanged
    ...
    private javax.swing.JLabel recommandEventLbl2;
    private javax.swing.JTable recommandEventTable;
    private javax.swing.JButton searchBtn1;
    private javax.swing.JTextField searchTxt;
    private javax.swing.JComboBox<String> sortFilterComboBox;
